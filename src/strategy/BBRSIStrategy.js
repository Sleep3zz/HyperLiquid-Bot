...
class BBRSIStrategy {
 ...
 this.rsiOverbought = Number(indicators.rsi.overbought) || 60; // MODIFIED: Was 75
 this.rsiOversold = Number(indicators.rsi.oversold) || 40; // MODIFIED: Was 25
 this.bbPeriod = Number(indicators.bollinger.period) || 20;
 this.bbStdDev = Number(indicators.bollinger.stdDev) || 1.5; // MODIFIED: Was 2
 this.adxPeriod = Number(indicators.adx.period) || 14;
 this.adxThreshold = Number(indicators.adx.threshold) || 35; // MODIFIED: Was 25
